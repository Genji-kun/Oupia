            ...
            <Dialog>
                ...
                <div className="flex flex-col gap-6">
                    <div className="w-full h-full">
                        <DialogTrigger asChild>
                            <Image src={images[1].url} alt="Asset Image 2" width={500} height={500} className="rounded-lg object-cover aspect-3/2 hover:cursor-pointer" loading='lazy'></Image>
                        </DialogTrigger>
                    </div>
                    <div className="w-full h-full">
                        <DialogTrigger asChild>
                            <Image src={images[2].url} alt="Asset Image 3" width={500} height={500} className="rounded-lg object-cover  aspect-3/2 hover:cursor-pointer" loading='lazy'></Image>
                        </DialogTrigger>
                    </div>
                </div>
                {images.length > 3 &&
                    <DialogTrigger asChild>
                        <Button className="styled-button absolute bottom-2 right-6">Xem tất cả hình ảnh</Button>
                    </DialogTrigger>
                }
