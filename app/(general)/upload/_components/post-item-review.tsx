...
const PostItemReview = () => {
    ...
    const {  tagAsset, post} = useUploadContext();
    const { currentUser } = useSelector((state: any) => state.currentUserSlice);
    const { images } = useUploadContext();

    return (
        <div className="border shadow bg-background dark:bg-oupia-base rounded-lg flex flex-col gap-y-2  shadow-dark-theme w-4/5 2xl:w-1/2 mx-auto">
